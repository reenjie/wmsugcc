...
function randomPassword() {
 ...
 $insert_reg = "INSERT INTO `student`(`stud_lname`, `stud_fname`, `stud_mname`, `stud_email`, `age`, `gender`, `status`, `contact_no`, `street`, `barangay`, `city`, `country`, `zipcode`, `stud_course`, `stud_college`, `fl`,`password`,`isverified`,`yearlevel`) VALUES ('$ln','$gn','$mi','$em','$age','$gender','$status','$cno','$st','$br','$cty','$ct','$zc','$course','$college','1','$pass','1','$year')";
...
if(isset($_POST['register_g'])){ 
	...
	if($course == 'noselection'){
		...
		if (preg_match("~@wmsu\.edu.ph$~",$em)){ 
 				...
 				$insert_reg = "INSERT INTO `student`(`stud_lname`, `stud_fname`, `stud_mname`, `stud_email`, `age`, `gender`, `status`, `contact_no`, `street`, `barangay`, `city`, `country`, `zipcode`, `stud_course`, `stud_college`,  `fl`,`password`,`isverified`,`yearlevel`)
 						VALUES ('$ln','$gn','$mi','$em','$age','$gender','$status','$cno','$st','$br','$cty','$ct','$zc','$course','$collegeid','0','$pass','1','$year')";
				mysqli_query($con,$insert_reg);
				$get_id =  mysqli_insert_id($con); 
