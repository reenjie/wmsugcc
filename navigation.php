...
<div class="modal" id="loginmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <script src="https://apis.google.com/js/client:platform.js?onload=start" async defer>
      ...
      <div class="row">
        <div class="col-md-6">
           <button class="mt-2 btn " type="button" style="float: right;font-size: 15px;width: 100%;height: 100%" onclick="window.location.href = '<?php echo $loginURL ?>';"><img src='https://developers.google.com/identity/images/g-logo.png' id="logingoogle" style="height: 15px;width: 15px;background-color: transparent;" > Google</button>
