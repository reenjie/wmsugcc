...
<style type="text/css">
   {
                ...
                <div class="container-fluid" id="pagefullsize_" >
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 id="title" class="h3 mb-0 text-gray-800">Shifting Records</h1>
                     ...
                     <div class="card shadow card_">
                         <div class="card-header card_">
                          ...
                          /* if(isset($_SESSION['noesign'])){
                            ?>
                            <h6 class="text-danger" style="font-size: 13px">E-sign Not Set. Please Setup the E-signature of the College Dean before completing transactions!</h6>
                            <a href="" style="font-size:13px" data-toggle="modal" data-target="#esign" data-backdrop="static" data-keyboard="false">Set Dean E-signature here..</a>
                            <?php
                           } */
                          ...
                          <div class="card-body table-responsive" id="tablecontents" >
                             ...
                             <button class="btn btn-light text-gray-700" onclick="window.location.href='declined.php'" style="font-size: 13px">View Declined Records</button>
                     </div> 
...
/*if(isset($_SESSION['noesign'])){
    ...
    Swal.fire(
  'E-Signature Not Set!',
  'Please set Dean`s E-sign  first to Approved or Decline Request!',
  'warning'
)
