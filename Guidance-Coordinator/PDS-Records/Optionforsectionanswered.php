  ...
  if($type =='checkbox') {
		...
		?>
		 ...
		 <!--	<h6 class="" style="text-align: left;border-bottom: 1px solid rgb(222, 226, 230)"><?php echo $rescontent ?></h6> -->
					 ...
					 <div class="col-sm-6">
								 			 		<h6 style="margin-left: 40px" class="mt-2"><label><input type="radio"   class="chkvalue" data-tid = "<?php echo $tid ?>"  id="radiocheck<?php echo $res['chid'] ?>" onClick="return false"   name="check<?php echo $rows['form_id'] ?>" value="<?php echo $res['content'] ?>" > <?php echo $res['content'] ?></label></h6>
