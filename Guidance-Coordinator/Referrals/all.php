...
<style type="text/css">
   {
                ...
                <div class="container-fluid" >
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 id="title" class="h3 mb-0 text-gray-800"><span class="text-primary">All Referrals</h1>
                                 ...
                                 <div class="col-md-12">
                                     <button class="btn btn-light mb-2" onclick="window.location.href='index.php' " style="font-size:14px"><i class="fas fa-arrow-left"></i></button> 
                                            ...
                                            <tbody>
                                                   ...
                                                   $getreferral_history = "SELECT * FROM `referral_history` where CollegeId = '$CollegeId' and status != 0  ";
