	...
	<h6 style="font-size:13px">Year : <?php echo $year ?></h6>
 	...
 	<script type="text/javascript">
 		  $(document).ready(function() {
 			 ...
 			 //fromdefcontent ('<?php echo $sem ?>','<?php echo $year ?>');
 			 todefcontent ('<?php echo $sem ?>','<?php echo $year ?>');
 		...
 		/*	function fromdefcontent(sem,year){
 				 ...
 				 url : "shift_contents.php",
 				  method: "POST",
 				 data  : {fromdefcontent:1,sem:sem,year:year},
 			...
 			function todefcontent(sem,year){
 				 ...
 				 url : "shift_contents.php",
 				  method: "POST",
 				 data  : {todefcontent:1,sem:sem,year:year},
 				  success : function(data){
 				 	$('#to_shift').html(data);
