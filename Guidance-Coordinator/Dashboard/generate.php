                ...
                $yrlevel = $_GET['yrlevel'];
         		...
         		<script type="text/javascript">
         			  $(document).ready(function() {
         			  	...
         			  	if(rep == 'shift'){
         			  		$('#courses_').attr('disabled',true);
                              $('#courses_').val('selectcourse');
         			  	}else {
         			  		$('#courses_').removeAttr('disabled');
                              $('#courses_').val('<?php echo $course ?>');
         			  
                    	}



         			  	content('<?php echo $sem ?>','<?php echo $yr ?>','<?php echo $coid ?>','<?php echo $typo ?>','<?php echo $rep ?>','<?php echo $course ?>','<?php echo $yrlevel ?>');

         			  	 	function content(sem,year,coid,typo,rep,course,yrlevel){
                		 $.ajax({
                		 url : "report.php",
                		  method: "POST",
                		 data  : {content:1,sem:sem,year:year,collegeid:coid,typo:typo,rep:rep,course:course,yrlevel:yrlevel},
              ...
              printpage();                
                ...
                $('#toprint').click(function(){
                  ...
                  //   alert(report);
                     ...
                     if(report == 'pendingpds'){
                       ...
                       if(report == 'shift'){
                            $('#titleofreport').val('Shifting Records');
                         $('#report_po').text('Shifting Records');  
                     }
                ...
                $('#titleofreport').keyup(function(){
                	...
                	$('#college_').change(function(){
                        ...
                        window.location.href='?sortby='+ty+'&sem='+sem+'&yr='+yr+'&coid='+col+'&typo='+ty+'&rep='+rep+'&course='+course+'&yrlevel='+yrlevel;
