...
<style type="text/css">
   {
                ...
                <div class="container-fluid" >
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 id="title" class="h3 mb-0 text-gray-800">Shiftees</h1>
...
#tableshownselection{
  ...
  color:#747f8c;
                ...
                <div class="container" id="getlarge">
                     ...
                     <div class="card shadow card_">
                         <div class="card-header card_">
                           ...
                           <a href="../Students" class="btn btn-light "><i class="fas fa-arrow-left"></i></a>
            ...
            $cid = $_SESSION['gc_collegid'];
                ...
                $sql = " select * from student where stud_id in (select stud_id from shifting_history where from_ = '$cid');  ";
                         ...
                         <tr>
                            <td>
                                    <a type="button" href="../Shifting-Records/student_record.php?id=<?php echo $idtoken ?>" class="btn btn-light form-control text-info" id ="<?php echo $idtoken ?>" target="_blank"  style="font-size: 13px;">Shifting Records
                                 <?php 

                                      $getalldata = "select * from shifting_history where stud_id = '$idtoken'  ";
                             ...
                             while($getsh = mysqli_fetch_array($shiftingdata)){
                              ...
                              <script type="text/javascript">
                                  $(document).ready(function() {
                                    $('#<?php echo $idtoken ?>').attr('disabled',true);
