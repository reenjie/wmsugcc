...
.col-sm-4 {
 ...
 .col-sm-1 {
  ...
  <div  class="introduction">
                                 ...
                                 <img class="wmsuimg" style="" src="../Guidance-Coordinator/img/bgwmsu.jfif">
                                  <img class="gccimg" style="" src="../Guidance-Coordinator/img/gcc.png">
                                 <div class="intro">
                                    ...
                                    if(isset($_GET['student-sf'])){ 
                                                            ...
                                                            $studdata = mysqli_query($con,$getstudentdata); 
                                                             ...
                                                             while($getstud = mysqli_fetch_array($studdata)){
                                                              ...
                                                              $crse = $getstud['stud_course'];
                                                                 ...
                                                                 $getstudcoursefrom = " select * from course where courseid = '$from'  ";
                                                                             $gcoursefrom = mysqli_query($con,$getstudcoursefrom); 
                                                                          
                                                                              while($getcoursefrom = mysqli_fetch_array($gcoursefrom)){
                                                                                $fromcourse = $getcoursefrom['course'];
                                                                              }

                                                                                $getstudcourseto = " select * from course where courseid = '$to'  ";
                                                                             $gcourseto = mysqli_query($con,$getstudcourseto); 
                                                                          
                                                                              while($getcourseto = mysqli_fetch_array($gcourseto)){
                                                                                $tocourse = $getcourseto['course'];
                                                                              }
                                                           ...
                                                           $studentdatas = mysqli_query($con,$studentformdatas); 
                                                            ...
                                                            while($row = mysqli_fetch_array($studentdatas)){
                                                             ...
                                                             $getresponsedata = " select * from form_response where formid = '$formid' ";
                                                              ...
                                                              $fromcolleges_ = "SELECT * FROM `colleges` where CollegeId = '$fromcollege' ";

                                                              $resultsss = mysqli_query($con,$fromcolleges_); // run query
                                                             
                                                               while($se = mysqli_fetch_array($resultsss)){
                                                                $fromcollege_id = $se['college'];
                                                               }


                                                              $toshift_college = "SELECT * FROM `colleges` where CollegeId = ' $tocollege' ";
                                                              ...
                                                              $resultss = mysqli_query($con,$toshift_college); // run query
                                                               ...
                                                               while($se = mysqli_fetch_array($resultss)){
                                                                $kolehiyotoshift = $se['college'];
                                                                   ...
                                                                   $sfdataeditable = " select * from sf_content where stud_id = '$studentid' and status = '$stat' and sfs='$sfs'  ";
                                       ...
                                       ?>	
                                        <div class="col-sm-6">
                                        	...
                                        	<span style="font-size: 14px">Course : <span style="font-weight: bolder;"><?php echo $fromcourse ?></span></span> <br>

                                        	<span style="font-size: 14px">Shifting to : <span style="font-weight: bolder;"><?php echo $tocourse ?></span> </span>
                                       	 ...
                                       	 <h6 style="font-weight: bolder;font-size: 14px"> For:   <div class="container">
                                               ...
                                               <div class="col-sm-4"></div> 
                                                <div class="col-sm-4"></div> 
                                       	 	 	 	 ...
                                       	 	 	 	 <div class="col-sm-4 mt-1" style="text-align: center;float: right;">
                                       	 	 	 	 	 <div class="" style=""> 
                              ...
                              <h6 style="font-weight: bolder;  text-decoration: underline;text-align: left;font-size: 14px">Certified:</h6><br>
                                                     ...
                                                     <div class="mb-2 ud" style="text-align: center;float: right;">
                                                       ...
                                                       <input type="file" name="" class="d-none" id="filer2" accept="image/*"> 
                                       	 	 	 		...
                                       	 	 	 		<h6 class="" style="font-size: 13px" >College:<span style="font-weight: bolder;text-decoration: underline;text-transform: uppercase;"><?php echo $fromcollege_id ?></span></h6>
                                            ...
                                            <p style="font-size: 14px" class="mt-4">
                                             ...
                                             <div class="row mt-2" >
                                                 ...
                                                 <div class="col-sm-4">
                                                     ...
                                                     <div class="mb-4 ud" style="text-align: center;float: right;"> 
                                                     <div  style="padding: 5px; height: 70px;cursor: pointer;">
                                                        <!--id="signature3"-->
                                                        <?php 
                                                        if($dean_s3 == ''){
                                                              ...
                                                              ?>
                                                                 <img src="<?php echo '../signatures/'.$esign ?>" id="imge3"  style="height: 70px;width: 170px" >
                                                            <?php */
                                                        }
                                                ...
                                                <h6 class="" style="font-size: 13px" >Date<input type="date" name="" style="text-align: center;border:none;outline:none;border-bottom: 1px solid black" class="changedate" value="<?php echo $d3 ?>" data-id="<?php echo $d3id ?>"></h6>
                                                 </div> 
