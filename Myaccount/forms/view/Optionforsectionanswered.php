	...
	?>
		...
		?>
		 <div class="row">
								 		...
								 		?>
								 		 <div class="col-md-6">
								 		 	<h6 style="margin-left: 40px" id="bg<?php echo $res['chid'] ?>" class="mt-2"><label><input type="radio" onclick="return false" class="changeradio" data-tid = "<?php echo $tid ?>"  data-value="<?php echo $res['content'] ?>"  id="radiocheck<?php echo $res['chid'] ?>" name="<?php echo $rows['form_id'] ?>"  value="<?php echo $res['content'] ?>" > <?php echo $res['content'] ?></label></h6>
								 		 </div> 
			...
			<?php
								 	...
								 	for($i = 0 ; $i <1;$i++){
								 		?>
								 		 <div class="col-md-6">
								 		 	<h6 id="bg<?php echo $res['chid'] ?>" style="margin-left: 40px" class="mt-2"><label><input type="radio"  onclick="return false" class="changeradio" data-tid = "<?php echo $tid ?>"  data-value="<?php echo $res['content'] ?>"  id="radiocheck<?php echo $res['chid'] ?>" name="<?php echo $rows['form_id'] ?>"  value="<?php echo $res['content'] ?>" > <?php echo $res['content'] ?></label></h6>
								 		 </div> 
		 ...
		 <div class="container">
		 	...
		 	<input type="checkbox" id="checkkk" class="d-none" checked="">
								 ...
								 //	echo 'optionforsectionanswered';
								 		...
								 		<h6 style="margin-left: 40px" id="bgch<?php echo $res['chid'] ?>" class="mt-2"><label><input type="checkbox" onclick="return false"  class="chkvalue<?php echo $rows['form_id'] ?> " data-tid = "<?php echo $tid ?>"  id="checkbox<?php echo $res['chid'] ?>"   name="check<?php echo $rows['form_id'] ?>" value="<?php echo $res['content'] ?>" > <?php echo $res['content'] ?></label></h6>
								 			<div class="ttttt"></div>
