...
<style type="text/css">
   ...
   z-index: 1;
	...
	#backbtn {
		font-size: 13px;position: fixed; left: 10px; top: 20px;font-weight: bolder;
	}
	@media screen and (max-width: 769px){
		#backbtn {
			position: fixed;left: unset;top: unset;right: 20px; border: 1px solid grey;z-index: 1; top: 10px;
		}
	}
</style>
</head>
...
<body style="background-color: <?php echo $bodybg ?>;">
	...
	<div class="row">
		<div class="col-md-2">
				 		<a href="../../" class="btn btn-light txt-dark" id="backbtn" style=""> MyAccount</a>
		</div>
		<div class="col-md-8">
								...
								if(isset($_GET['section'])){
									...
									//	echo $formid;
						                 ...
						                 if($countnumb == 0){
						                 	...
						                 	<!--	<button   class="btn btn-primary ml-2  px-4"  onclick="window.close()" style="margin-left: 10px;background-color: #4e73df;padding: 10px">Exit Page</button> -->

						                 	<h6 style="text-align: center;font-weight: bolder;" class="mt-4">** Nothing Follows **</h6>		
