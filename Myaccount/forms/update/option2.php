			               		 		      	...
			               		 		      	$('.txtuptcontent').focusout(function(){ 
			               		 		      		...
			               		 		      		var tid = $(this).data('tid');
			               		 		      		   ...
			               		 		      		   $.ajax({
			               		 		      		           url : "saving.php",
			               		 		      		            method: "POST",
			               		 		      		             data  : {upttxtcontents1:1,val:val,tid:tid},
				      	...
				      	$('.changeradio').click(function() {
				      		...
				      		var tid = $(this).data('tid');
				      			  ...
				      			  $.ajax({
			               		 		      		           url : "saving.php",
			               		 		      		            method: "POST",
			               		 		      		             data  : {uptmpchoice1:1,val:newval,tid:tid},
			               		 		      		             success : function(data){
			               		 		      			 $('#applychanges').removeClass('d-none');
											               		 		      		             	var clear = setInterval(function(){
											               		 		      		             		$('#applychanges').addClass('d-none');
			...
			<?php
								 		  	...
								 		  	<h6 style="margin-left: 40px" ><label><input type="radio" class="changeradioss<?php echo $rows['form_id'] ?>" data-tid = "<?php echo $tid ?>" name="<?php echo $rows['form_id'] ?>" data-value="10" id="check<?php echo $rows['form_id'] ?>"  > 
												...
												<script type="text/javascript">
													...
													$(document).ready(function() {
													     	$('#val<?php echo $rows['form_id'] ?>').focusout(function(){ 
													     		var val = $(this).val();
													     		var tid = $(this).data('tid');
													     		$.ajax({
			               		 		      		           url : "saving.php",
			               		 		      		            method: "POST",
			               		 		      		             data  : {uptmpchoice1:1,val:val,tid:tid},
			               		 		      		             success : function(data){
			               		 		      			 $('#applychanges').removeClass('d-none');
											               		 		      		             	var clear = setInterval(function(){
											               		 		      		             		$('#applychanges').addClass('d-none');
		...
		<?php
		 ...
		 <div class="container">
		 	...
		 	<input type="checkbox" id="checkkk" class="d-none" checked="">
				...
				<script type="text/javascript">
					...
					$(document).ready(function() {
					      	...
					      	$('.uncheckall<?php echo $rows['form_id'] ?>').focusout(function(){ 
											            ...
											            $.each($("input[name='check<?php echo $rows['form_id'] ?>']:checked"), function(){
											           	...
											           	//	alert(sThisVal);
													     	 ...
													     	 $.ajax({
			               		 		      		           url : "saving.php",
			               		 		      		            method: "POST",
			               		 		      		             data  : {uptcheckbox1:1,val:sThisVal,tid:tid},
			               		 		      		             success : function(data){
			               		 		      					$('.ttttt').html(data);
			               		 		      					 $('#applychanges').removeClass('d-none');
											               		 		      		             	var clear = setInterval(function(){
          ...
          $.ajax({
									...
									$('.txtsavetotemp').focusout(function(){ 
										var val=$(this).val();
										var tid = $(this).data('tid');
		...
		?>
			               		 	...
			               		 	<script type="text/javascript">
			               		 		...
			               		 		$(document).ready(function() {
			               		 		      	...
			               		 		      	$(".txtuptcontent").on("change",function(){
													      var val = $(this).val();
			               		 		      		var tid = $(this).data('tid');
