								 ...
								 /*	if($secno >=1){
								 	...
								 	*/
								 	 ...
								 	 ?>
								 		...
								 		<div class="dtupt<?php echo $formid ?>"></span></div>
								 	 ...
								 	 <div class="container mt-3">
								 	 		<span class="badge bg-danger" style="position: absolute; right: 10px; top: 20px; "> Modified </span>
										   	 ...
										   	 <tr>
										     	...
										     	<?php 
										   					$selectcontents = " SELECT * FROM `tablecolumn_content` where tc_id = '$tcId'  ";
																...
																<input type="text" class="tcont" data-tid= "<?php echo $pdsrespo['pds_id'] ?>"  value="<?php echo $pdsrespo['response'] ?> " style="width: 100%;font-size:14px">
													   							</td>
													   								...
													   								$(document).ready(function() {
													   								     ...
													   								     $('#applychanges').removeClass('d-none');
													   								         ...
													   								         $.ajax({
											               		 		      		           url : "saving.php",
											               		 		      		            method: "POST",
											               		 		      		             data  : {upttable1:1,val:val,tid:tid},
											               		 		      		             success : function(data){
								 	 		...
								 	 		$('.filllist').focusout(function(){ 
								 	 			...
								 	 			var tid = $(this).data('tid');
								 	 			  ...
								 	 			  $.ajax({
								 	 			           url : "saving.php",
								 	 			            method: "POST",
								 	 			             data  : {filllist1:1,val:val,tid:tid},
								 	 			             success : function(data){
