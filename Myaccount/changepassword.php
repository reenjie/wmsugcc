      ...
      <button type="button" class="btn btn-primary d-none" id="cp" data-toggle="modal" data-target="#usergreetings_guide" data-backdrop="static" data-keyboard="false" >
        ...
        <div class="modal-dialog " role="document">
          ...
          <span aria-hidden="true">&times;</span>
                         ...
                         <div class="row">
                                  ...
                                  <h6 style="font-weight: bolder;">CHANGE YOUR PASSWORD <span class="text-danger" style="font-size:11px">(REQUIRED in First Login)</span></h6>
