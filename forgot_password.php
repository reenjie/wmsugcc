    ...
    <div class="progress-bar" id="myBar"></div>
     ...
     <div class="container mt-5">
        <div class="row">
           ...
           <div class="card-body">
              <h5 style="font-weight: bolder;">Password Recovery : <span style="color:white"><?php echo md5('ReenjayCaimor')?></span></h5>
              <hr>


               <div class="container">
                 
                <h6>Account Recovery for Guidance and Counseling Center  Accounts <br>Please Provide the Email registered to your account. you must have access through the given Email.</h6>

                <br>
                 <div class="row">
                    <div class="col-md-2"></div> 
                     <div class="col-md-8">
                         <input type="text" name="" class="form-control" id="email" placeholder="Enter EMAIL here.">
                          <div class="invalid-feedback">
                                      Email does not exist in our database. If you forgot your email. please visit your guidance coordinator to further assist you with your issue.
                                    </div>

                                     <div class="valid-feedback">
                                     We have sent a code to the email above, Please Provide the code to the textbox below to reset password.
                                    </div>
