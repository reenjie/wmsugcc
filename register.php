		 	 		  ...
		 	 		  <div class="col-md-8 ">
		 	 		  	 ...
		 	 		  	 <div class="card shadow">
		 	 		  	 	 <div class="card-body">
		 	 		  	 	 	...
		 	 		  	 	 	<input type="text" id="emm" class="form-control" style="font-size: 14px" name="em" required="" autofocus>
		 	 		  	 	 	...
		 	 		  	 	 	<input type="text" class="form-control" style="font-size: 14px" name="age" required="" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
		 	 		  	 	 	 	    </div> 
...
<div class="collapse show" id="collapseExample">
  <div class="card card-body">
   					<h6 style="font-size:14px">
		 	 		  	 	 	 ...
		 	 		  	 	 	 <button type="submit" id="regbtn" class="form-control btn btn-success mt-2"> Register</button>
		 ...
		 $(document).ready(function() {
              ...
              var val = $(this).val();
                if(val == ''){
                       ...
                       $.ajax({
               url : "admin/accounts/validate.php",
                method: "POST",
               data  : {checkemail:1,val:val},
		 		                  ...
		 		                  method: "POST",
		 		                   ...
		 		                   success : function(data){
											  ...
											  'error',
		 		      						...
		 		      						$('#regbtn').attr('disabled',true);
		 		      						$('#regbtn').html('Submitting <i class="fas fa-spinner fa-pulse"></i>');
