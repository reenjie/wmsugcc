...
// Change password || comparison
	 if(isset($_POST['compare'])) {
        ...
        */
        ...
        $adpos = '';
          ...
          $dsp = 'admin_'.$adln;
             $sql = " INSERT INTO `administrator`(`admin_lname`, `admin_fname`, `admin_mname`, `admin_dsplyname`, `admin_type`, `admin_email`,`admin_password`,`CollegeId`,`ft`,`admin_banner`,`admin_sidebarbg`,`admin_contactno`,`admin_effectivedate`,`admin_position`) 
             VALUES ('$adln','$adfn','$admn','$dsp','$adty','$adem','$hashedpass','$coll','1','$adty ADMIN','#63a284','$cn','$ed','$adpos')  ";
    ...
    $sql = " UPDATE `administrator` SET `admin_lname`='$adln',`admin_fname`='$adfn',`admin_mname`='$admn',`admin_type`='$adty',`admin_email`='$adem',`CollegeId`='$uptcol', `admin_effectivedate`='$addate' ,`admin_position` = '$adpos1' WHERE admin_id='$adid' ";
                          $result = mysqli_query($con,$sql); // run query
