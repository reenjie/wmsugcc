 <?php $office = 1; ?>
  <div class="container">
      ...
      <table class="table table-striped table-hover  table-sm" id="tableadmins" >
          ...
          <tbody>
            <?php 
                $sql = "  SELECT * FROM `administrator` where admin_type ='ADMISSION'  ";
              ...
              if($admintoken == $adminid){
                ...
                <script type="text/javascript">
                  ...
                  $(document).ready(function() {
                          ...
                          $('#admintb'+<?php echo $adminid ?>).addClass('table-success');
                        });      
               ...
               var id = $(this).data('adminid');
                ...
                if (result.isConfirmed) {
                  location.reload();
                                       ...
                                       xhttp.open("POST", "../../mailer/sendreset_adcredentials.php",true);
