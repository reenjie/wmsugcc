                    ...
                    <div class="card shadow">
                      ...
                      <div class="card-body">
                        ...
                        <div class="mt-4 text-center small">
                          <span class="mr-2">
                            <i class="fas fa-circle text-primary"></i> Guidance Counseling Center
                          </span>
                          <span class="mr-2">
                            <i class="fas fa-circle text-success"></i> Guidance Coordinator
                          </span>
                  ...
                  <div class="col-md-8">
                    <div class="card shadow mb-2">
                      <div class="card-header">
                        <h6 class="m-0 font-weight-bold text-primary">Accounts Data Statistics in Percentage</h6>
                      </div>

                      <div class="card-body">


                        <label style="font-size: 12px" class="mt-4">Guidance Counseling Center</label>
                        <div class="progress">
                          <div class="progress-bar bg-success" id="progress_gcc" role="progressbar" style="width: 0%;"
                            aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">0%</div>
                        </div>

                        <label style="font-size: 12px" class="mt-4">Guidance Coordinator</label>
                        <div class="progress">
                          <div class="progress-bar bg-danger" id="progress_gc" role="progressbar" style="width: 0%;"
                    ...
                    <div class="card shadow mb-2 mt-2">
                      <div class="card-body">
                        <h6 style="font-weight: bolder;">Visitors</h6>
                        <button class="btn btn-light text-danger deleteall" style="font-size:12px ;float: right;">Clear
                          all visitor Records</button>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="card">
                          <div class="card-body" style="text-align: center;height: 200px">
                            <img src="../../GCC/img/gcc.png" style="width: 140px;">
                            <h6 style="font-size: 13px" class="text-primary">Guidance Counseling Center</h6>
                          </div>
                      ...
                      <div class="col-md-4">
                        <div class="card">
                          <div class="card-body" style="text-align: center;height: 200px">
                            <img src="../../GCC/img/gcc.png" style="width: 140px;">
                            <h6 style="font-size: 13px" class="text-primary">Guidance Coordinator</h6>
                          </div>
                      ...
                      <div class="col-md-4">
                        <div class="card">
                          <div class="card-body" style="text-align: center;height: 200px">
                            <img src="../../GCC/img/gcc.png" style="width: 140px;">
                            <h6 style="font-size: 13px" class="text-primary">Student</h6>
                          </div>
