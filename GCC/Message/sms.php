...
session_start();
 ...
 if(isset($_POST['getconvo'])){
 	...
 	$update_to_read = "UPDATE `message` SET `status`='1'  WHERE stud_id = '$id' and send = '$id' and status = 0 and adm= 0";
	mysqli_query($con,$update_to_read);
 	   ...
 	   $get_messagesdata = "select * from message where stud_id = '$id' and gcc = 0 and adm = 0 ;";
 ...
 if(isset($_POST['inbox'])){
                    										...
                    										$get_inbox = "select * from student where stud_id in (select stud_id from message where adm = 0 and gcc = 0 )  ";
                    									...
                    									<div class="card-body">
                    										<h6 style="font-size:14px;" class="text-secondary"><?php echo $row['stud_fname'].' '.$row['stud_mname'].' '.$row['stud_lname'] ?>
                    											...
                    											<?php 
                    												...
                    												$getnewsms = "select * from message where stud_id = '$studid' and adm =0 and send = '$studid' and status = 0   ";
...
$sendsms = "INSERT INTO `message`(`message`, `stud_id`,`status`,`receive`,`datecreated`) VALUES ('$val','$id','0','$id','$datenow')";
...
$delconvo= "UPDATE `message` SET `gcc`='1' WHERE stud_id= '$id' and adm = '0'  and send ='$user' or send='$id'  ";
...
$delconvo= "UPDATE `message` SET `gcc`='1' WHERE msg_id = '$removesms'  ";
