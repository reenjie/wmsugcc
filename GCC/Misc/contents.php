			...
			<p></p>
				<div class="row">
					 ...
					 <div class="container">
					 		 ...
					 		 <div class="row" style="height: 50px;background-color: <?php echo $_SESSION['sidebar_color'] ?>">
					 		 	<h5 style="color: white;padding: 15px;text-align: center;"><?php echo $_SESSION['sidebar_color'] ?></h5>
					 		 </div> 
					 		 	<br>
					<h6>Change to </h6>
					<br>
   ...
   <div class="" style="border:2px solid#e3efea"></div> 
	...
	if(isset($_POST['changeemail'])){ 
		?>
			...
			<h5>Change System Email <i style="font-size: 22px;" class="fas fa-cog"></i></h5>
			<p></p>
				<div class="row">
					 	<button id="btnverification" class="d-none" data-toggle="modal" data-target="#verificationcode" data-backdrop="static" data-keyboard="false"> triggerre</button>
					
					 	 <div class="card py-3 mb-4" style="width: 100%">

					 	 	<p></p>
					 	 	 <div class="container">
					 	 	 		<label>Current System Email <i class="fas fa-cogs"></i></label>
					 	 	 		<?php 
					 	 	 				$sql = " SELECT * FROM `gui` where id=1  ";
					 	 	 		                $result = mysqli_query($con,$sql); 
					 	 	...
					 	 	while($row = mysqli_fetch_array($result)){
					 	 	 		 ...
					 	 	 		 ?>
					 	 	<input type="text" name="" class="form-control" value="<?php echo $systememail ?>" readonly="">
					 	 	 </div> 
					 	 	 <p></p>
					 	 ...
					 	 <i class="fas fa-info-circle"></i>	Changing the Default Email If done incorrectly, it might result in an error or the inability to send any email messages. To avoid this, follow our instructions on how to change your email address.


					 	 </p>
					 	 <p>
  <a class="btn btn-light"  style="font-size: 12px; float: right;" data-toggle="collapse" href="#collapseExampless" role="button" aria-expanded="false" aria-controls="collapseExample">
   INSTRUCTION
  </a>
...
<div class="collapse " id="collapseExampless">
 <p style="font-size: 14px">
 	Note : Please use Gmail only. <br>
 	1.)To change an email address under this system, first log in to the account you wish to use, then go to myaccount/security and turn on <a href="https://myaccount.google.com/lesssecureapps?" target="_blank">Less Secure Apps Access</a> or navigate here, <a  target="_blank" href="https://myaccount.google.com/security?">https://myaccount.google.com/security?</a> 
 	<br>
   2.) After enabling  Less secure apps access, enter the correct email and password in the fields below. For the system to verify the account's legitimacy, The system will send codes and  you'll need to provide the verification code. <br>
   3.) Once it's been validated. The new email address will be saved in the system. <br>
   4.) if there is an Error Please refer to the instructions or return to the default settings. <br>
				...
				<div class="card py-3 mb-4" style="width: 100%">
					 <div class="card-header">
					 	<span>Please provide a valid account</span>
					 </div> 
					 	
					 	    	    <input type="hidden" name="changesystememail">              
					 
					 	
					 	 	<p></p>
					 	 	 <div class="container">
					 	 	 		<label>Enter New Email <span style="color: red">*</span>: </label>
					 	 	<input type="email" name="newemail" id="newemail" required="" class="form-control"  style="font-size: 13px">
					 	 	<span style="color: red;font-size: 12px" id="errore"></span>
					 	 	<br>
					 	 	<label>Enter Password <span style="color: red">*</span> : </label>
					 	 	<input type="password" name="newpass" id="newpass" required="" class="form-control"  style="font-size: 13px" >
					 	 	<span  style="color: red;font-size: 12px" id="errorp"></span>
					 	 	 </div> 
					 	 	 <p></p>
					 	 	
					 	 	
					 	 </div> 
					 	 <button type="submit" class="btn btn-primary mr-2" id="changesystememail"  style="font-size: 12px;float: right;">SAVE CHANGES</button> 
		
						<button class="btn btn-secondary" type="button" id="resetsystememail" style="font-size: 12px;float: right;">RESET TO DEFAULT</button>
