...
<?php 
	 ...
	 if($type == 'shorttext') {
		...
		<input type="text" class="txtboxtransition txtsavetotemp txtuptcontent" name="<?php echo $rows['form_id'] ?>" data-tid = "<?php echo $tid ?>" data-idform ="<?php echo $rows['form_id'] ?>" value="<?php echo $rescontent ?>" style="width: 60%; margin-left: 10px;"  placeholder="" required=""> 
		...
		<input type="text" class="txtboxtransition txtsavetotemp txtuptcontent" value="<?php echo $rescontent ?>"  data-tid = "<?php echo $tid ?>" name="<?php echo $rows['form_id'] ?>" data-idform ="<?php echo $rows['form_id'] ?>" style="width: 60%; margin-left: 10px;" placeholder="" > 
		...
		?>
		 <div class="row">
								 		...
								 		?>
								 		 <div class="col-md-6">
								 		 	<h6 style="margin-left: 40px" class="mt-2"><label><input required type="radio" class="changeradio" data-tid = "<?php echo $tid ?>"  data-value="<?php echo $res['content'] ?>"  id="radiocheck<?php echo $res['chid'] ?>" name="<?php echo $rows['form_id'] ?>"  value="<?php echo $res['content'] ?>" > <?php echo $res['content'] ?></label></h6>
								 		 </div> 
		...
		<input type="email" class="txtboxtransition txtsavetotemp txtuptcontent" data-tid = "<?php echo $tid ?>" value="<?php echo $rescontent ?>" data-idform ="<?php echo $rows['form_id'] ?>" required="" name="<?php echo $rows['form_id'] ?>" style="margin-left: 10px;width: 60%"  placeholder=""> 
		 </div> 
		 <input type="hidden" name="inputdatasection" value="<?php echo $secno ?>">
		...
		<?php
			...
			?>
		 <div class="container" >
		<input type="email" class="txtboxtransition txtsavetotemp txtuptcontent" data-tid = "<?php echo $tid ?>" value="<?php echo $rescontent ?>" data-idform ="<?php echo $rows['form_id'] ?>" name="<?php echo $rows['form_id'] ?>" style="margin-left: 10px;width: 60%"  placeholder=""> 
		...
		<input type="text" class="txtboxtransition txtsavetotemp txtuptcontent" data-tid = "<?php echo $tid ?>" value="<?php echo $rescontent ?>" data-idform ="<?php echo $rows['form_id'] ?>" required="" name="<?php echo $rows['form_id'] ?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" style="width: 60%;margin-left: 10px;"  placeholder=""> 
		 </div> 
		<input type="hidden" name="inputdatasection" value="<?php echo $secno ?>">
		...
		<input type="text" class="txtboxtransition txtsavetotemp txtuptcontent" data-tid = "<?php echo $tid ?>" value="<?php echo $rescontent ?>" data-idform ="<?php echo $rows['form_id'] ?>" name="<?php echo $rows['form_id'] ?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" style="width: 60%;margin-left: 10px;"  placeholder=""> 
		 </div> 
		 <input type="hidden" name="inputdatasection" value="<?php echo $secno ?>">
		...
		<input type="date" required="" class="form-control txtuptcontent" data-tid = "<?php echo $tid ?>" name="<?php echo $rows['form_id'] ?>" style=" text-align: center;"  placeholder="" value="<?php echo $rescontent ?>"> 
		 </div> 
		 <input type="hidden" name="inputdatasection" value="<?php echo $secno ?>">
		...
		<input type="date" class="form-control txtuptcontent" data-tid = "<?php echo $tid ?>" name="<?php echo $rows['form_id'] ?>" style=" text-align: center;"  placeholder=""  value="<?php echo $rescontent ?>"> 
		 </div> 
		 <input type="hidden" name="inputdatasection" value="<?php echo $secno ?>">
