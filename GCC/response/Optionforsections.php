								 	...
								 	<?php
										...
										if($isspecified == 1){
								 		   ...
								 		   <p></p>
								 		   	...
								 		   	<a href="javascript:void(0)" class="btn btn-light text-primary d-none mt-2" id="btn<?php echo $rows['form_id'] ?>" style="font-size: 12px">Refresh Selection <i class="fas fa-sync"></i></a>
								 		   <?php
								 		   }else {
