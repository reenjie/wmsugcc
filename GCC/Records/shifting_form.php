  ...
  background: #30936f; 
                     	...
                     	<div class="container">
                     		<nav aria-label="breadcrumb">
							  <ol class="breadcrumb">
							    ...
							    <li class="breadcrumb-item active">Shifting Forms</li>
                    ...
                    <li class="breadcrumb-item"><a href="filter.php">Filtering</a></li>
                     	  ...
                     	  <div class="card shadow mb-2">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Shifting Forms</h6>
                                </div>
                                <div class="card-body" style="font-size: 14px">

                                    <?php $shifting=0; include 'advsorting.php'; ?>
   ...
   // include '../encrypt/sfgcc.php';
    //$enc =  new encryptdata();
        ...
        $sqls = " select * from form_response where userid='$studentid' and csformid = '60' ";
