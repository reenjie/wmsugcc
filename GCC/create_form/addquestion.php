<?php 
	$csform = $_SESSION['form_id'];
							...
							if(isset($_SESSION['sectionset'])){
								...
								/////
				              	 ...
				              	 ////the add code
				               	   $sqlinsert = " INSERT INTO `form`( `type`, `content`,`class_name`,`display_order`,`status`,`isrequired`,`sec_no`,`section`) VALUES ('Question','Untitled Question','$csform','$neword','selected','no','$section_no','$formiddd')  ";
 	  	...
 	  	$sqlinsert = " INSERT INTO `form`( `type`, `content`,`class_name`,`display_order`,`status`,`isrequired`,`sec_no`,`section`) VALUES ('Question','Untitled Question','$csform','$neword','selected','no','$section_no','$formiddd')  ";
				                ...
				                $sqlinsert = " INSERT INTO `form`( `type`, `content`,`class_name`,`display_order`,`status`,`isrequired`,`sec_no`,`section`) VALUES ('Question','Untitled Question','$csform','$dorder','selected','no','$section_no','$sectionsetid')  ";
				               	 $results = mysqli_query($con,$sqlinsert); // run query
				               	 	             }else {
   $sqlinsert = " INSERT INTO `form`( `type`, `content`,`class_name`,`display_order`,`status`,`isrequired`,`sec_no`,`section`) VALUES ('Question','Untitled Question','$csform',0,'selected','no','$section_no','$sectionsetid')  ";
				               	 $results = mysqli_query($con,$sqlinsert); // run query
   ...
   $sqlinsert = " INSERT INTO `form`( `type`, `content`,`class_name`,`display_order`,`status`,`isrequired`,`sec_no`,`section`) VALUES ('Question','Untitled Question','$csform',0,'selected','no','$section_no','$sectionsetid')  ";
				                ...
				                $sqlinsert = " INSERT INTO `form`( `type`, `content`,`class_name`,`display_order`,`status`,`isrequired`,`sec_no`,`section`) VALUES ('Question','Untitled Question','$csform','$dorder','selected','no','$secno','$formidsss')  ";
				               	 $results = mysqli_query($con,$sqlinsert); // run query
				               	 	             }else {
   $sqlinsert = " INSERT INTO `form`( `type`, `content`,`class_name`,`display_order`,`status`,`isrequired`,`sec_no`,`section`) VALUES ('Question','Untitled Question','$csform',0,'selected','no','$secno','$formidsss')  ";
				               	 $results = mysqli_query($con,$sqlinsert); // run query
   ...
   $sqlinsert = " INSERT INTO `form`( `type`, `content`,`class_name`,`display_order`,`status`,`isrequired`,`sec_no`,`section`) VALUES ('Question','Untitled Question','$csform',0,'selected','no','$secno','$formidsss')  ";
				                ...
				                $sqlinsert = " INSERT INTO `form`( `type`, `content`,`class_name`,`display_order`,`status`,`isrequired`) VALUES ('Question','Untitled Question','$csform','$dorder','selected','no')  ";
				               	 $results = mysqli_query($con,$sqlinsert); // run query
				               	 	             }else {
   $sqlinsert = " INSERT INTO `form`( `type`, `content`,`class_name`,`display_order`,`status`,`isrequired`) VALUES ('Question','Untitled Question','$csform',0,'selected','no')  ";
				               	 $results = mysqli_query($con,$sqlinsert); // run query
