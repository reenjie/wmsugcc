<?php 
	$csform = $_SESSION['form_id'];
							...
							if(isset($_SESSION['sectionset'])){
				              	 ...
				              	 ////the add code
				               	  $sqlinsert = " INSERT INTO `form`( `type`, `content`,`class_name`,`display_order`,`status`,`isrequired`,`sec_no`,`section`) VALUES ('list','Untitled list','$csform','$neword','selected','no','$section_no','$formiddd')  ";
				             ...
				             ////the add code
				               ...
				               $sqlinsert = " INSERT INTO `form`( `type`, `content`,`class_name`,`display_order`,`status`,`isrequired`,`sec_no`,`section`) VALUES ('list','Untitled list','$csform','$dorder','selected','no','$section_no','$sectionsetid')  ";
				               	 $results = mysqli_query($con,$sqlinsert); // run query
				               	 	             }else {
   $sqlinsert = " INSERT INTO `form`( `type`, `content`,`class_name`,`display_order`,`status`,`isrequired`,`sec_no`,`section`) VALUES ('list','Untitled list','$csform',0,'selected','no','$section_no','$sectionsetid')  ";
				               	 $results = mysqli_query($con,$sqlinsert); // run query
  ...
  $sqlinsert = " INSERT INTO `form`( `type`, `content`,`class_name`,`display_order`,`status`,`isrequired`,`sec_no`,`section`) VALUES ('list','Untitled list','$csform',0,'selected','no','$section_no','$sectionsetid')  ";
				               ...
				               $sqlinsert = " INSERT INTO `form`( `type`, `content`,`class_name`,`display_order`,`status`,`isrequired`,`sec_no`,`section`) VALUES ('list','Untitled list','$csform','$dorder','selected','no','$secno','$formidsss')  ";
				               	 $results = mysqli_query($con,$sqlinsert); // run query
				               	 	             }else {
   $sqlinsert = " INSERT INTO `form`( `type`, `content`,`class_name`,`display_order`,`status`,`isrequired`,`sec_no`,`section`) VALUES ('list','Untitled list','$csform',0,'selected','no','$secno','$formidsss')  ";
				               	 $results = mysqli_query($con,$sqlinsert); // run query
  ...
  $sqlinsert = " INSERT INTO `form`( `type`, `content`,`class_name`,`display_order`,`status`,`isrequired`,`sec_no`,`section`) VALUES ('list','Untitled list','$csform',0,'selected','no','$secno','$formidsss')  ";
							...
							$csform = $_SESSION['form_id'];
				               ...
				               $sqlinsert = " INSERT INTO `form`( `type`, `content`,`class_name`,`display_order`,`status`,`isrequired`) VALUES ('list','Untitled list','$csform','$dorder','selected','no')  ";
				               	 $results = mysqli_query($con,$sqlinsert); // run query
				               	 	             }else {
   $sqlinsert = " INSERT INTO `form`( `type`, `content`,`class_name`,`display_order`,`status`,`isrequired`) VALUES ('list','Untitled list','$csform',0,'selected','no')  ";
				               	 $results = mysqli_query($con,$sqlinsert); // run query
