...
.col-sm-4 {
 ...
 .col-sm-1 {
  ...
  <div  class="introduction">
                                 ...
                                 <h5 style="">Guidance and Counceling Center </h5>
                                    ...
                                    //  echo $formid;
                                      ...
                                      $isspecified = $row['isspecified'];
                                       ...
                                       // echo $row['content'];
                                        ...
                                        $checkifanswered = " SELECT * FROM `form_response` where formid = '$formid' and custom_user='$studentid' and tble = 0 and list = 0  and csformid = '$pdsform' ";
