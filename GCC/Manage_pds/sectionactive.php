...
if($dd == 'file'){
		...
		?>
					...
					<button type="button" class=" mb-2 text-primary attchlink" id="btnattachlink<?php echo $formid  ?>" style="font-size: 13px;background-color: transparent;border: none;outline: none;cursor: default;"><h6 style="font-size: 14px" ><i class="fas fa-paperclip"></i>  Attach File</h6></button>
					<br>
	...
	if($dd == 'Title') { 
										   	...
										   	?>
										   	 ...
										   	 <tr>
										     	...
										     	<?php 
													...
													<input type="text" name="" style="width: 100%;font-size:14px" disabled="">
										   							</td>
			 ...
			 <li class="list-group-item"  >
			 		...
			 		if($cct == 'Untitle list'){
			 			?>
			 			<input type="text" name="" style="width: 100%;font-size: 13px" placeholder="" disabled="">
			 			<?php
			 		}else {
			 			?>
