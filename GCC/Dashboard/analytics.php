                           ...
                           while($row = mysqli_fetch_array($gcol)){
                                ...
                                $bgcolor = $row['bgcolor'];
                                        ...
                                        $countingstudpending= mysqli_num_rows($numberforstudpending);
                                         ...
                                         $getstudentcountcompleted = "select * from student where stud_college = '$collid' and pds_filled ='1'   ";
                       ...
                       if ($getcc1>=1){
                           ...
                           while($row = mysqli_fetch_array($gcol1)){
                                ...
                                $bgcolor = $row['bgcolor'];
                                        ...
                                        $getstudentcountpending = "SELECT * FROM `shifting_history` where status = 'processing' and from_='$collid'  ";
                                        $numberforstudpending = mysqli_query($con,$getstudentcountpending); 
                                        $countingstudpending= mysqli_num_rows($numberforstudpending);

                                         $getstudentcountcompleted = "SELECT * FROM `shifting_history` where status = 'Approved' and from_='$collid'  ";
                                        $numberforstudcompleted = mysqli_query($con,$getstudentcountcompleted); 
                                        $countingstudcompleted= mysqli_num_rows($numberforstudcompleted);
           ...
           <div class="container">
            ...
            <div class="card shadow mt-2">
                <div class="card-body">
                    ...
                    <a href="../Records/shifting_form.php" style="font-size:12px">View Shifting completed Records</a>
