<?php 
												 ...
												 if($rep == 'Notfilledup'){
											  	 if($collegeid == 'all'){
											  	 	$get_student_data = "select * from student where pds_filled = 0 and stud_id not in (select userid from temp_answers where csformid = '62')  ";
														...
														$get_student_data = "select * from student where pds_filled = 0 and stud_college = '$collegeid' and stud_course='$course' and stud_id not in (select userid from temp_answers where csformid = '62')   ";														
														}
											  	...
											  	if($collegeid == 'all'){
											  	 	$get_student_data = "select * from student where pds_filled = 0 and stud_id  in (select userid from temp_answers where csformid = '62') and yearlevel ='$yrlevel'  ";
											  	 		...
											  	 		if($course == 'selectcourse'){
															...
															$get_student_data = "select * from student where pds_filled = 0 and stud_college = '$collegeid' and stud_course ='$course' and stud_id in (select userid from temp_answers where csformid = '62') and yearlevel ='$yrlevel'  ";													
														}
											  ...
											  if($rep =='completedpds'){
											  	 	...
											  	 	$get_student_data = "select * from student where pds_filled = 1 and pds_filledsem ='$sem' and year(pdsfilleddate)='$year' and stud_id  in (select userid from form_response where csformid = '62') and yearlevel ='$yrlevel'  ";
											  	 		...
											  	 		if($course == 'selectcourse'){
											  	 			 	$get_student_data = "select * from student where pds_filled = 1 and stud_college = '$collegeid' and pds_filledsem ='$sem' and year(pdsfilleddate)='$year' and stud_id in (select userid from form_response where csformid = '62') and yearlevel ='$yrlevel'  ";

												}else {
												
												 	$get_student_data = "select * from student where pds_filled = 1 and pds_filledsem ='$sem' and year(pdsfilleddate)='$year' and  stud_college = '$collegeid' and stud_course ='$course' and stud_id in (select userid from form_response where csformid = '62') and yearlevel ='$yrlevel'  ";														
											}
