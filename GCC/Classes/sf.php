  ...
  <div  class="introduction">
                                 ...
                                 <br>
                                  ...
                                  <div class="container"> 
                                    ...
                                    if(isset($_GET['student-sf'])){ 
                                       ...
                                       ?>	
                                        <div class="col-sm-6">
                                        	<span style="font-size: 14px">Name : <span style="font-weight: bolder;"><?php echo $name ?></span> </span> <br>
                                        	...
                                        	<span style="font-size: 14px">Shifting to : <span style="font-weight: bolder;"><?php if(isset($coursetoshift)){ echo $coursetoshift; }else { echo 'Null'; } ?></span> </span>
                                       	 ...
                                       	 <h6 style="font-weight: bolder;font-size: 14px"> For:   <div class="container">
                                       	 	 ...
                                       	 	 <div class="container mt-4">
                                       	 	 	 <h6 style="font-size: 14px">The Academic Record: CET <u style="font-size: 1px; border-bottom: 1px solid black;padding-right: 200px"></u> APPTITUDE<u style="font-size: 1px; border-bottom: 1px solid black;padding-right: 200px"></u> <br><br>
                                       	 	 	 	...
                                       	 	 	 	shows that Mr/Ms <span style="font-weight: bolder; text-decoration: underline;"><?php echo $name ?></span>  can shift to another course.
                                       	 ...
                                       	 <div class="col-sm-12 mt-1">
                                       	  	 ...
                                       	  	 <h6 style="font-weight: bolder;font-size: 14px"> For:   <div class="container">
                                       	  		<h6 style="font-weight: bolder; font-size: 14px"> The Dean</h6> 
                                       	  		 <span>College: <span style="font-weight: bolder;text-decoration: underline;"><?php echo  $kolehiyotoshift ?></span></span>
                              ...
                              <h6 style="font-weight: bolder;  text-decoration: underline;text-align: left;font-size: 14px">Certified:</h6><br>
                                                     ...
                                                     <div class="mb-2 ud" style="text-align: center;float: right;"> 
                                       	 	 	 		...
                                       	 	 	 		<h6 class="" style="font-size: 13px" >College:<span style="font-weight: bolder;text-decoration: underline;"><?php echo $kolehiyo ?></span></h6>
                                         ...
                                         <br>
                                            ...
                                            <p style="font-size: 14px" class="mt-4">
                                              ...
                                              Mr/Ms. <span style="font-weight: bolder; text-decoration: underline;"><?php echo $name ?></span> is accepted/not accepted to the <span style="font-weight: bolder;text-decoration: underline;"><?php if(isset($coursetoshift)){ echo $coursetoshift; }else { echo 'Null'; } ?></span>.
                                            </p>
                                             ...
                                             <div class="row mt-2" >
                                                ...
                                                <h6 class="" style="font-size: 13px" >College:<span style="font-weight: bolder;"><?php echo  $kolehiyotoshift ?></span></h6>
                                                <h6 class="" style="font-size: 13px" >Date<u style="font-size: 1px; border-bottom: 1px solid black;padding-right: 250px"></u></h6>
                                                 </div> 
