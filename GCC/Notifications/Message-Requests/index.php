...
background: radial-gradient(circle, rgba(222,235,233,0.4906337535014006) 0%, rgba(222,235,232,1) 1%, rgba(158,214,148,1) 4%, rgba(222,235,233,1) 100%);">
                       ...
                       <div class="card-body">
                        ...
                        <h2 style="float: right;font-family: 'Handlee', cursive;font-size: 80px;user-select: none">REQUEST</h2>
...
<script src="https://code.jquery.com/jquery-3.5.1.min.js"></script>
        ...
        <input type="hidden" name="" id="notification_id">
            ...
            <button type="button" class="btn btn-light mt-4 ml-2 replymessagerequest"  style="font-size: 12px;float: right;width: 100px" 
